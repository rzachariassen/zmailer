...
\subsection{Autoconfiguration}\index{build!autoconfiguration}

This system uses several preferably separate partitions for
different things:\index{build!disk partitions}
\begin{itemize}
...
\subsubsection{Install Preparation}\index{build!install/upgrade preparation}
...
\subsubsection{Installation}\index{build!installation}
